            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a class="page-scroll" href="#">Recuperação de senha</a>
                        </li>
                        <li>
                    ...
                    <div class="row-fluid">
                        <div class="col-lg-6 pull-right ">
                            ...
                            <form action="../control/recuperarSenha.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="email" class=" form-control" name="emailLogin" id="emailLogin" maxlength="150" placeholder="maisa@email.com" >
                                </div>
