...
require_once '../class/ParticipaEvento.php';
...
<div class="container">
                            ...
                            <?php foreach ($eventos as $evento) { ?>
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        if ($participacaoDAO->verifPresenca($participacao)) {
    ...
    <?php } else { ?>
                                            <form class="span1" method="post" action="../control/presencaEventoSalvar.php">

                                                <label><?php echo $evento->getNroParticipantes() . "&nbsp;pessoas&nbsp;confirmaram&nbsp;presença" ?> </label>

                                                <input type="hidden" id="cd" name="cd" value="<?php echo $evento->getIdEvento() ?>"/>
                                                <a><button type="submit" class="btn-link">Participar&nbsp;<i class="aweso-group aweso-large"></i></button></a>
                                            </form>   
    <?php } ?>
                                    </td> 
                                </tr> 
