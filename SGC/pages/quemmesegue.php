...
$usuariosSeguidos = $usuarioSeguidoDAO->listarQuemMeSegue();
?>
<!-- MEUS EVENTOS
================================================== -->
<div class="container">
        ...
        <div class="widget-content">
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="posts">
                    ...
                    <h2 align="center">Meus Seguidores </h2>
                    ...
                    <table id="datatables1" class="table  table-hover">
                        ...
                        <tbody> 
                            ...
                            foreach ($usuariosSeguidos as $usuarioSeguido) {
                                $usuario = $usuarioDAO->buscarPorId($usuarioSeguido->getIdUsuario());
                                ?>
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        <?php if ($usuario->getStatus() == 1) { ?>
                                            ...
                                            <?php
                                            echo "<br><br><br>" . $usuario->getNome() . " , " . $paisDAO->buscarPorId($usuario->getIdPais())->getNome() . "-" . $usuario->getEstado();
                                        } else {
                                            ?>
                                            <img class="media-object pull-left" style="width: 60px; height: 50px;" src="<?php echo "../" . $caminhoImagens . "" . "noimg.png" ?>"/>
                                            <?php
                                            echo "<br><br><br>" . "Usuário Desativado" . " , " . $paisDAO->buscarPorId($usuario->getIdPais())->getNome() . "-" . $usuario->getEstado();
                                        }
                                        ?>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
